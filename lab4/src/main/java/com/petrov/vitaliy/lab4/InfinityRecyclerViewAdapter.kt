...
class InfinityRecyclerViewAdapter(private val items: List<Item>) :
    RecyclerView.Adapter<InfinityRecyclerViewAdapter.ViewHolder>() {
    ...
    init {
        mOnClickListener = View.OnClickListener { v ->
            ...
            Log.d("onClick (infinity)", item.author + " " + item.title + " " + item.journal)
    ...
    override fun getItemCount(): Int {
        Log.d("getItemCount (infinity)", items.size.toString())
        return items.size
    }
